    ...
    (_createClass(t, [
      ...
      },
      {
        ...
        value: function () {
          ...
          (t = document.getElementById("shuicheCanvas")) &&
            t.getContext &&
            ((o = t.getContext("2d")),
      ...
      },
      {
        ...
        value: function () {
          var t = P(
            "<div id='shuicheDiv' style='position: fixed;width: 100%;height: " +
              P(window).height() +
              "px; left: 0px; top: 0px; z-index: 2147483647;pointer-events:none;'></div>"
          );
          P("body").append(t),
            new ((function () {
              function i(t) {
